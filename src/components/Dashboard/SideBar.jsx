...
const SideBar = () => {
    ...
    <ul className="side-nav-dash">
      ...
      <li className={`side-nav-dash__item${pathname=="dashboard" ? "--active" : ""}`}>
        <Link to="/dashboard" className={`side-nav-dash__link${pathname=="dashboard" ? "--active" : ""}`}>
          <FontAwesomeIcon className="side-nav-dash__icon" icon={faHome}></FontAwesomeIcon>
          <p>Home</p>
        </Link>
      </li>
      <li className={`side-nav-dash__item${pathname=="chat" ? "--active" : ""}`}>
      <Link to="/chat" className={`side-nav-dash__link${pathname=="chat" ? "--active" : ""}`}>
          <FontAwesomeIcon className="side-nav-dash__icon" icon={faCommentDots}></FontAwesomeIcon>
          <span>Chat room</span>
      </Link>
      </li>
      <li className={`side-nav-dash__item${pathname=="mytrips" ? "--active" : ""}`}>
      <Link to="/myTrips" className={`side-nav-dash__link${pathname=="mytrips" ? "--active" : ""}`}>
