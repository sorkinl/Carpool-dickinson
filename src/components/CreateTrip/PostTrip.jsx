...
import { CssBaseline, Snackbar, Grid } from "@material-ui/core";
...
export default function PostTrip(props) {
  ...
  function handleSubmit(e) {
    ...
    if (checkEmptyInput() === false) {
      ...
      departTime = timeToPick.toLocaleTimeString([], {
        hour: "2-digit",
        minute: "2-digit",
      });
        ...
        <div className="post-trip">
          ...
          <div className="post-trip-main">
            <div className="post-trip-cont">
              <div
                disabled={showSpinner === false}
                className="post-trip-cont--front-content"
              >
                ...
                <div className="post-trip-form post-trip-front-page">
                  <form>
                    <label htmlFor="origin-field">
                      ...
                      <AutoLocation
                        id="origin-field"
                        onSuggestionSelect={handleOriginChange}
                        placeholder={"From"}
                      />
                    </label>
                    <label htmlFor="dest-field">
                      ...
                      <AutoLocation
                        onSuggestionSelect={handleDestinationChange}
                        placeholder={"To"}
                      />
                    </label>
                ...
                <div className="post-trip-img">
                  <div className="post-trip-img__text side-illustration">
                    <img
                      src={adventure}
                      alt=""
                      className="post-trip-img__text side-illustration side-image"
                    />
                  </div>
                  <div className="post-trip-img__text">
                    <p>Ready to share your ride?</p>
                  </div>
                  {isSubmitted === "listening" ||
                  isSubmitted === "submit-error" ? (
                    <a href="/postTrip/confirm">
                      <div
                        className="post-trip-img__btn"
              ...
              {showSpinner === false ? (
                <div className="post-trip-confirm">
                  <p className="post-trip-confirm__text post-trip-confirm__text--header">
                    Your trip has been posted
                    <span>
                      <FontAwesomeIcon
                        className="post-trip-confirm__text--icon"
                        icon={faCheckCircle}
                      ></FontAwesomeIcon>
                    </span>
                  </p>
                  <p className="post-trip-confirm__text post-trip-confirm__text--caption">
                    We'll notify you when someone books your trip
                  </p>
                  <div className="post-trip-confirm center-illustration">
                    <img
                      src={world}
                      alt=""
                      className="post-trip-confirm center-illustration center-image"
                    />
                  </div>
                  <Grid
                    container
                    spacing={1}
                    className="post-trip-confirm__btnSet"
                  >
                    <Grid item xs={5}>
                      <a to="/postTrip">
